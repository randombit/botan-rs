...
impl IpAddrBlocks {
    ...
    pub(crate) fn from_cert(cert: &Certificate) -> Result<IpAddrBlocks> {
        let obj = botan_init!(
            botan_x509_ext_create_ip_addr_blocks_from_cert,
            cert.handle()
        )?;
        Ok(IpAddrBlocks { obj })
    }
    ...
    pub fn new() -> Result<IpAddrBlocks> {
        let obj = botan_init!(botan_x509_ext_create_ip_addr_blocks)?;
        Ok(IpAddrBlocks { obj })
    }
...
impl ASBlocks {
    ...
    pub(crate) fn from_cert(cert: &Certificate) -> Result<ASBlocks> {
        let obj = botan_init!(botan_x509_ext_create_as_blocks_from_cert, cert.handle())?;
        Ok(ASBlocks { obj })
    }

    pub fn new() -> Result<ASBlocks> {
        let obj = botan_init!(botan_x509_ext_create_as_blocks)?;
        Ok(ASBlocks { obj })
    }
