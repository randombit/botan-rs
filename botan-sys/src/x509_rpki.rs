...
extern "C" {
    ...
    pub fn botan_x509_ext_create_ip_addr_blocks(
        ip_addr_blocks: *mut botan_x509_ext_ip_addr_blocks_t,
    ) -> c_int;
    pub fn botan_x509_ext_create_ip_addr_blocks_from_cert(
        ip_addr_blocks: *mut botan_x509_ext_ip_addr_blocks_t,
    ...
    pub fn botan_x509_ext_create_as_blocks(as_blocks: *mut botan_x509_ext_as_blocks_t) -> c_int;
    pub fn botan_x509_ext_create_as_blocks_from_cert(
