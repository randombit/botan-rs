...
extern "C" {
    ...
    pub fn botan_mp_lshift(out: botan_mp_t, in_: botan_mp_t, shift: usize)
        -> c_int;
    pub fn botan_mp_rshift(out: botan_mp_t, in_: botan_mp_t, shift: usize)
        -> c_int;
    pub fn botan_mp_mod_inverse(
        out: botan_mp_t,
        in_: botan_mp_t,
        modulus: botan_mp_t,
    ) -> c_int;
    pub fn botan_mp_rand_bits(
        rand_out: botan_mp_t,
        rng: botan_rng_t,
        bits: usize,
    ) -> c_int;
